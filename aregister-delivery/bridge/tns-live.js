...
// Last-resort CSV fallback for when TNSERVICES is unreachable (e.g. a non-Indian IP)
// or returns empty. Uses mpqr-resolver's getDistrictsTree, which loads data/tn-districts.csv
// — only a SMALL SAMPLE of districts/villages, NOT the full state. Real dropdowns +
// name→code resolution require a live connection to the portal from an Indian IP; off
// India this fallback returns only the handful of sampled rows.
