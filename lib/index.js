...
async function completeVerification(pendingId, otp, opts = {}) { return _require().completeVerification(pendingId, otp, opts); }
async function resendOtp(pendingId) { return _require().resendOtp(pendingId); }
async function borrowParcel(verifiedId, parcel) { return _require().borrowParcel(verifiedId, parcel); }
...
module.exports = {
  init,
  prewarm, beginVerification, completeVerification, resendOtp, borrowParcel,
